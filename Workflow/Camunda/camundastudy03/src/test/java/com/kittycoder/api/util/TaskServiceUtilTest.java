...
public class TaskServiceUtilTest extends CamundastudyApplicationTests {

    @Test
    public void findProcessDefinitionEntityByTaskId() {
        String taskId = "9b3bb3f2-97fa-11e9-85a9-00ff05c8d50b";
        ProcessDefinition pd = TaskServiceUtil.findProcessDefinitionEntityByTaskId(taskId);
    ...
    public void findActivityImpl() {
        String taskId = "9b3bb3f2-97fa-11e9-85a9-00ff05c8d50b";
        ActivityImpl activityImpl = TaskServiceUtil.findActivityImpl(taskId, "end");
